...
class PaymentSelectViewController: UIViewController {
 ...
 //   var onClickPayment: ((PaymentType, CardResponseData?)-> Void)? //change payment mode from request
    ...
    override func viewDidLoad() {
        ...
        self.title = isFromAddAmountWallet == true || isChangePayment == true ? APPLocalize.localizestring.choosePayment.localize() : APPLocalize.localizestring.payment.localize()
        // Do any additional setup after loading the view.
        
     //   self.setNavigationTitle()
      //  self.setLeftBarButtonWith(color: .black)
        self.view.backgroundColor = .lightGray
        self.tableView.register(nibName: APPLocalize.localizestring.PaymentTypeTableViewCell)
...
//        let cell: PaymentTypeTableViewCell = self.tableView.dequeueReusableCell(withIdentifier: APPLocalize.localizestring.PaymentTypeTableViewCell, for: indexPath) as! PaymentTypeTableViewCell
...
//                cardFooterView.backgroundColor = .veryLightGray

...
//    }
    ...
    func load(url: URL,placeHolderImage:UIImage?=nil,completion: @escaping ((UIImage) -> Void)) {
        ...
        if let _  = placeHolderImage {
            ...
            image = UIImage(named: APPLocalize.localizestring.imagePlaceHolder)?.imageTintColor(color1: UIColor.lightGray.withAlphaComponent(0.8))
        }
